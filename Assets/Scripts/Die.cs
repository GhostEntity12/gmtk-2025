...
public class Die : MonoBehaviour
{
	...
	public DieFace RandomFace => faces[Random.Range(0, faces.Count)];
	...
	private void Update()
	{
		...
		if (IsStopped())
		{
			Debug.Log(GetTopFace().Value);
			TimeTester.Instance.RegisterRoll(Time.time - startTime, GetTopFace().Value);
			isRolling = false;
		}
	}
	...
	private DieFace GetTopFace()
	{
		return faces.OrderByDescending(f => f.YPos).FirstOrDefault();
	}

	public bool IsStopped()
	{
		return rb.angularVelocity == Vector3.zero && rb.linearVelocity == Vector3.zero;
	}

	public int[] GetFaceValues()
	{
		return faces.Select(f => f.Value).ToArray();
	}
}
...
public readonly struct Transformations
{
	...
	{
		{ new(000, 000, 000), new(180, 000, 000), new(270, 000, 000), new(090, 000, 000), new( 90, 000, 000), new(270, 000, 000), },
		{ new(180, 000, 000), new(000, 000, 000), new(090, 000, 000), new(270, 000, 000), new(270, 000, 000), new(090, 000, 000), },
		{ new(270, 000, 000), new(090, 000, 000), new(000, 000, 000), new(180, 000, 000), new(000, 000, 270), new(000, 000, 090), },
		{ new(090, 000, 000), new(270, 000, 000), new(180, 000, 000), new(000, 000, 000), new(000, 000, 090), new(000, 000, 270), },
		{ new(270, 000, 000), new(090, 000, 000), new(000, 000, 090), new(000, 000, 270), new(000, 000, 000), new(180, 000, 000), },
		{ new(090, 000, 000), new(270, 000, 000), new(000, 000, 270), new(000, 000, 090), new(180, 000, 000), new(000, 000, 000), },
	};
	public static readonly Vector3[,] d8 =
	{
		...
		{ new(000, 180, 180), new(000, 000, 000), new(000, 000, 180), new(000, 180, 000), new(000, 270, 180), new(000, 090, 000), new(000, 090, 180), new(000, 270, 000), },
		{ new(000, 180, 180), new(000, 000, 000), new(000, 000, 180), new(000, 180, 000), new(000, 270, 180), new(000, 090, 000), new(000, 090, 180), new(000, 270, 000), },
		{ new(000, 000, 180), new(000, 180, 000), new(000, 180, 180), new(000, 000, 000), new(000, 090, 180), new(000, 270, 000), new(000, 270, 180), new(000, 090, 000), },
		...
		{ new(000, 090, 180), new(000, 270, 000), new(000, 270, 180), new(000, 090, 000), new(000, 180, 180), new(000, 000, 000), new(000, 000, 180), new(000, 180, 000), },
		...
		{ new(000, 270, 180), new(000, 090, 000), new(000, 090, 180), new(000, 270, 000), new(000, 000, 180), new(000, 180, 000), new(000, 180, 180), new(000, 000, 000), },
	};
}
